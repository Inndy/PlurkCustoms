var __languages = {
    "en": {
        ...
        "<div style='border:3px dashed gray;margin:10px;padding:10px;position:relative;'><p>備份方式：將上方的檔案圖示拖曳至桌面儲存，或點選右鍵另存</p><p>還原方式：將備份的檔案拖曳到虛線框中</p><p>取代模式：圖庫將被完全刪除並置換成檔案的內容</p><p>合併模式：從備份的檔案中補足圖庫中缺少的圖片</p></div>": "<div style='border:3px dashed gray;margin:10px;padding:10px;position:relative;'><p><b>Backup</b>: Drag the icon upside to your desktop, or right-click and save it. </p><p><b>Restore</b>: Drag backup file into dashed line area.<br> And there are two methods to restore.</p><p><b>Replace Mode</b>: The whole gallery will be consistent with the file. </p><p><b>Merge Mode</b>: Only the missing part of emoticons will restored. </p></div>",
        "取代模式": "Replace Mode",
        "合併模式": "Merge Mode",
        "%d 張圖片": "%d emoticons",
