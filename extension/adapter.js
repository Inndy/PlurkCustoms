...
StorageAdapter.prototype.loadEmotions = function(callback) {
        ...
        this.sendExtensionRequest({
            ...
            emotions = _.map(emotions, function(emo) {
                return _.pick(emo, ['hash_id', 'url', 'keyword']);
            })
...
PlurkEmotiland.prototype.isAlive = function(keyword, callback) {
    var alive = _.findWhere(this.cache, {
        keyword: keyword
    });
...
PlurkEmotiland.prototype.getOnlineEmoticons = function(callback) {
    ...
    if (self.cache.length) {
        ...
        $.ajax({
            url: "//www.plurk.com/EmoticonManager/getUserEmoticons",
            data: {
                token: token
            },
            dataType: 'json',
...
PlurkEmotiland.prototype.addEmotion = function(url, keyword, callback) {
    ...
    var exitst = _.findWhere(this.cache, {
        hash_id: hash_id
    });
    if (exitst) {
        callback && callback();
        ...
        $.ajax({
            url: "//www.plurk.com/EmoticonDiscovery/addEmoticon",
            data: {
                form_token: token,
                url: url,
                hash_id: hash_id,
...
PlurkEmotiland.prototype.removeEmotion = function(url, callback) {
    ...
    $.ajax({
        url: "//www.plurk.com/EmoticonDiscovery/removeEmoticon",
        data: {
            form_token: token,
            hash_id: hash_id
        },
        ...
        success: function(response) {
            ...
            self.cache = _.reject(self.cache, function(e) {
...
PlurkEmotiland.prototype.getDefaultSmiles = function(callback) {
    ...
    getLocal('GLOBAL', function(GLOBAL) {
        getLocal('_Emoticons', function(Emoticons) {
            ...
            var emoticons = [{
                url: "//s.plurk.com/47d20905d017c396d67b4a30c9ac9b10.png",
                keyword: "(goal)",
                alias: "ball"
            }, {
                url: "//s.plurk.com/5a2a63fa773e68797ec69a1303bfa3b9.png",
                keyword: "(bzzz)",
                alias: "buzz"
            }, {
                url: "//s.plurk.com/7256dae81d56d150120ccd0c96dd2197.gif",
                keyword: "(fireworks)"
            }, {
                url: "//s.plurk.com/4ad099fba019942f13058610ff3fc568.gif",
                keyword: "(dance_bzz)",
                alias: "buzz"
            }, {
                url: "//s.plurk.com/deda4d9f78ad528d725e3a6bfbf6352f.gif",
                keyword: "(Русский)",
                alias: "(Pyccknn)"
            }, {
                url: "//s.plurk.com/0efc4d55d28704f4370ef874ae906161.gif",
                keyword: "(code)"
            }, {
                url: "//s.plurk.com/4c40d16a0d369b895c08f2e33d062ec8.gif",
                keyword: "(yarr)"
            }, {
                url: "//s.plurk.com/1a5f23ed863e70e52f239b045a48e6fb.gif",
                keyword: "(xmas1)",
                alias: "christ"
            }, {
                url: "//s.plurk.com/f5dbd5fdf5f5df69cfb024d6be76a76b.gif",
                keyword: "(xmas2)",
                alias: "christ"
            }, {
                url: "//s.plurk.com/e902170e97aee14836b5df6b0fe61ba2.gif",
                keyword: "(xmas3)",
                alias: "christ"
            }, {
                url: "//s.plurk.com/e476574723d5042f24658fa36866bd92.gif",
                keyword: "(xmas4)",
                alias: "christ"
            }, {
                url: "//s.plurk.com/a555399b40c379adca5b6f5bad5bf732.gif",
                keyword: "(dance_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/bb1e3fed482959a00013f7f1efcc17a0.gif",
                keyword: "(music_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/bac8c8392f7ca8f5ac74612be4d08b74.gif",
                keyword: "(wave_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/71acd802cc931649dd9a371ccf70bad2.gif",
                keyword: "(hungry_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/3acbaf42504fff32c5eac4f12083ce56.gif",
                keyword: "(yar_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/fcd28d7d78ec1f828c76930fa63270e6.gif",
                keyword: "(gym_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/8855f56400a936db07f348d9290adaac.gif",
                keyword: "(code_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/feb43dbbbf2763905571060be9a496d1.gif",
                keyword: "(no_dance)",
                alias: "dance"
            }, {
                url: "//s.plurk.com/5b51892d7d1f392d93ea7fe26e5100f4.gif",
                keyword: "(banana_gym)",
                alias: "dance"
            }, {
                url: "//s.plurk.com/6de58c967f1c2797d250a713ba50eddd.gif",
                keyword: "(dance_yarr)",
                alias: "dance"
            }, {
                url: "//s.plurk.com/88fac5a4b99110a35d4e4794dad58ab4.gif",
                keyword: "(taser_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/6675254cd7449b1847a93b0024127eae.gif",
                keyword: "(angry_okok)",
                alias: "okok"
            }, {
                url: "//s.plurk.com/b3b9856e557fcc2700fd41c53f9d4910.gif",
                keyword: "(droid_dance)",
                alias: "dance"
            }, {
                url: "//s.plurk.com/cfdd2accc1188f5fbc62e149074c7f29.png",
                keyword: "(fuu)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/828b9819249db696701ae0987fba3638.png",
                keyword: "(gfuu)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/1bd653e166492e40e214ef6ce4dd716f.png",
                keyword: "(yay)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/3fe6cf919158597d7ec74f8d90f0cc9f.png",
                keyword: "(gyay)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/9c5c54081547d2ad903648f178fcc595.png",
                keyword: "(bah)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/2da76999ca3716fb4053f3332270e5c9.png",
                keyword: "(gbah)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/f73b773aa689647cb09f57f67a83bb89.png",
                keyword: "(troll)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/45beda260eddc28c82c0d27377e7bf42.png",
                keyword: "(gtroll)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/8590888362ae83daed52e4ca73c296a6.png",
                keyword: "(aha)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/c7551098438cc28ec3b54281d4b09cc3.png",
                keyword: "(gaha)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/cfd84315ebceec0c4389c51cf69132bd.png",
                keyword: "(whatever)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/0e0bf1ec2c2958799666f3995ef830ca.png",
                keyword: "(gwhatever)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/e2998ca75f80c1c4a5508c549e3980a6.png",
                keyword: "(pokerface)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/c6ad1c4f9e11f6859a1ba39c4341ef8b.png",
                keyword: "(gpokerface)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/4a61085f1c6a639f028cd48ae97d07d0.png",
                keyword: "(yea)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/53253ca60f5831f0812954213a2e9bb3.png",
                keyword: "(gyea)",
                alias: "rage"
            }, {
                url: "//s.plurk.com/6928f3117658cc38d94e70519a511005.png",
                keyword: "(jazzhands)",
                alias: "rage"
            }, {
                url: "//www.plurk.com/static/emoticons/valentine/lingerie.png",
                keyword: "v_shy"
            }, {
                url: "//www.plurk.com/static/emoticons/valentine/tiffany-box.png",
                keyword: "v_tiffany"
            }, {
                url: "//www.plurk.com/static/emoticons/valentine/heart-love.png",
                keyword: "v_love"
            }, {
                url: "//www.plurk.com/static/emoticons/valentine/perfume.png",
                keyword: "v_perfume"
            }, {
                url: "//www.plurk.com/static/emoticons/valentine/envelope.png",
                keyword: "v_mail"
            }, {
                url: "//www.plurk.com/static/emoticons/lantern/lantern-love.png",
                keyword: "lantern_love"
            }, {
                url: "//www.plurk.com/static/emoticons/lantern/lantern-well.png",
                keyword: "latern_well"
            }, {
                url: "//www.plurk.com/static/emoticons/lantern/lantern-peace.png",
                keyword: "lantern_peace"
            }, {
                url: "//www.plurk.com/static/emoticons/lantern/lantern-health.png",
                keyword: "lantern_health"
            }, {
                url: "//www.plurk.com/static/emoticons/lantern/lantern-fortune.png",
                keyword: "lantern_fortune"
            }, {
                url: "//www.plurk.com/static/emoticons/lantern/lantern-happy.png",
                keyword: "lantern_happy"
            }, ]
            for (var i in a) emoticons.push({
                url: a[i][1],
                keyword: a[i][2]
            });
